...
public class ActivityServiceImpl implements ActivityService {
  ...
  public ActivityDTO createActivity(ActivityDTO activityDTO) {
    ...
    Activity createdActivity =
        activityRepository.createActivity(ActivityMapper.instance.mapToActivity(activityDTO));
  ...
  public ActivityDTO updateActivity(String id, ActivityDTO activityDTO) {
    ...
    Activity activity =
        activityRepository.updateActivity(id, ActivityMapper.instance.mapToActivity(activityDTO));
    userRepository
        .listUsers()
        .forEach(
            user -> {
              if (userHasActivity(user, id)) {
                user.getActivities()
                    .set(
                        user.getActivities().indexOf(activity),
                        ActivityMapper.instance.mapToActivity(activityDTO));
              }
            });
